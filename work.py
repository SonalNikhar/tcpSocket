...
class Server(QMainWindow):
    ...
    def tradeFiletoNumpy(self):
        ...
        # path = r'\\192.168.102.222\Shared\OnlineTrades\20221111\20221111.txt'
        ...
        if (lines != []):
            ...
            for k in lines:
                ...
                for izzz in self.clientList:
                    print('dd', self.clientdict)

                    cc=self.clientdict[izzz]
                    i = k.split(',')
                    if(cc==i[10]):
                        jd = k.encode('UTF-8')
                        size=len(jd)
            ...
            try:
                ...
                if(data['Type']=='Auth'):
                    ...
                    if(self.status=='Invalid User'):
                        ...
                        self.clientdict[self.clientConnection]=self.CliCode
