...
class Server(QMainWindow):
    ...
    def On_readyRead(self):
        try:
            ...
            common_keys = set(self.client_Dict.keys()) & set(tradesDict.keys())

            self.client_Dict.update(tradesDict)
            ...
            if df.shape[0] != 0:
                ...
                df = df.groupby(['TerminalID', 'Token', 'Series', 'Symbol', 'BuySell']).aggregate(
